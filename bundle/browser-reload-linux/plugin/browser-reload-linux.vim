...
function! s:ReloadBrowser(browser, ...)
    ...
    " In i3wm the above xdotool call will fail with error => 'XGetWindowProperty[_NET_WM_DESKTOP] failed (code=1)'
    " This is a dirty workaround with i3-msg
    exec "silent ! i3-msg '[class = \"Firefox\"]focus'; xdotool key ctrl+r"
